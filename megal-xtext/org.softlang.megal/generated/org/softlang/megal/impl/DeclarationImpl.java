 ...
 *   <li>{@link org.softlang.megal.impl.DeclarationImpl#getOrigin <em>Origin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DeclarationImpl extends MinimalEObjectImpl.Container implements Declaration
{
	...
	public void setOrigin(Object newOrigin)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MegalPackage.DECLARATION__ORIGIN, oldOrigin, origin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case MegalPackage.DECLARATION__ORIGIN:
				return getOrigin();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			case MegalPackage.DECLARATION___ALL_ANNOTATIONS:
				return allAnnotations();
			case MegalPackage.DECLARATION___MEGAMODEL:
				return megamodel();
			case MegalPackage.DECLARATION___LOGIC_EQ__EOBJECT:
				return logicEq((EObject)arguments.get(0));
			case MegalPackage.DECLARATION___IDENTITY:
				return identity();
		}
