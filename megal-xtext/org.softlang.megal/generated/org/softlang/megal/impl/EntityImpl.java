...
public class EntityImpl extends NamedImpl implements Entity
{
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			case MegalPackage.ENTITY___APPLICABLE_OUTGOING__ENTITY:
				return applicableOutgoing((Entity)arguments.get(0));
			case MegalPackage.ENTITY___APPLICABLE_INCOMING__ENTITY:
				return applicableIncoming((Entity)arguments.get(0));
		}
